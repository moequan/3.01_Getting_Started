...
var firstName="Maurice";
var lastName="Schubarth";
...
var name="Maurice Schubarth";
var city="Berlin";
var job="Tech";
var hobby="xyz, abc, tech";
const languages="javascript, html, css";

console.log (lastName, name, city, job, hobby, languages);

//5. 5. Print the sentence "John Smith is a 43 year old teacher who lives in Berlin" using variables (where possible) and text. **you can combine variables with text in the console by using the plus symbol (+) e.g. console.log("this is a " + variable);**
